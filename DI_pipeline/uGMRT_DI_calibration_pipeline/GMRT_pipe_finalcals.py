...
logprint ("Starting GMRT_pipe_finalcals.py", logfileout='logs/finalcals.log')
...
if (cal3C84_d == True):
    ...
    caltable='finaldelayinitialgain.g'
    field=delay_field_select_string
    spw=tst_delay_spw  # leave end channels for gaincal (Arnab during summer 2019)
    intent=''
    selectdata=True
    uvrange=''
    scan=delay_scan_select_string
...
if (cal3C84_d == True):
    ...
    caltable='finaldelay.k'
    field=delay_field_select_string
    spw=tst_delay_spw # Do not use edge channels during delay cal (by Arnab during summer of 2019)
    intent=''
    selectdata=True
    uvrange=''
    scan=delay_scan_select_string
...
if (cal3C84_bp == True):
    ...
    caltable='finalBPcal.b'
    field=bandpass_field_select_string
    spw=tst_delay_spw   # Do not use edge channels during bandpass (by Arnab during summer of 2019)
    selectdata=True
    uvrange=''
    scan=bandpass_scan_select_string
    solint='inf'
...
logprint ("Finished GMRT_pipe_finalcals.py", logfileout='logs/finalcals.log')
