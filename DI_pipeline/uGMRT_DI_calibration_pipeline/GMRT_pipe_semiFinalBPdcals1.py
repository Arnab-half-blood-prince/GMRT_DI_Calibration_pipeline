...
logprint ("Starting GMRT_pipe_semiFinalBPdcals1.py", logfileout='logs/semiFinalBPdcals1.log')
...
if (cal3C84_bp == True):
    ...
    caltable='BPinitialgain.g'
    field=''
    spw=tst_bpass_spw         # Central good  channels. (Arnab during summer 2019)
    selectdata=True
    uvrange=''
    scan=bandpass_scan_select_string
    solint=gain_solint1
...
if (cal3C84_bp == True):
    ...
    caltable='BPcal.b'
    field=bandpass_field_select_string
    spw=tst_delay_spw   ## Leaving the edge channel 
    selectdata=True
    uvrange=''
    scan=bandpass_scan_select_string
    solint='inf'
    ...
    refant=refAnt
    minblperant=minBL_for_cal
    minsnr=2.0       # Made it 2. Earlier it was 5.0 
    solnorm=False
    bandtype='B'
    fillgaps=0
    smodel=[]
...
logprint ("Finished GMRT_pipe_semiFinalBPdcals1.py", logfileout='logs/semiFinalBPdcals1.log')
