...
logprint ("Starting GMRT_pipe_fluxflag.py", logfileout='logs/fluxflag.log')
...
iteration=''
showgui= False
figfile = 'flux_gain_to_fluxboot_all_ant.png'
plotcal()

## If this plot shows drastic variation in amp vs time then need to check the cal again ### 

logprint ("Finished GMRT_pipe_fluxflag.py", logfileout='logs/fluxflag.log')
