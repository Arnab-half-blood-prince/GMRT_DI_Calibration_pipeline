...
logprint("Starting GMRT_pipe_flag_baddeformattersphase.py", logfileout='logs/flag_baddeformattersphase.log')
...
logprint ("Finished GMRT_pipe_flag_baddeformattersphase.py", logfileout='logs/flag_baddeformattersphase.log')
