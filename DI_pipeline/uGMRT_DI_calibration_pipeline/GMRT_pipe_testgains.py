...
logprint ("Starting GMRT_pipe_testgains.py", logfileout='logs/testgains.log')
...
soltime=int_time
solint='int'
tst_gcal_spw=tst_bpass_spw  ## choosing the central channels to do gaincal 
combtime='scan'
...
logprint ("Finished GMRT_pipe_testgains.py", logfileout='logs/testgains.log')
