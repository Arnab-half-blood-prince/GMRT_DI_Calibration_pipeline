...
# use TFcorp mode of flagdata

logprint ("Starting GMRT_TFcrop.py", logfileout='logs/checkflag.log')
...
logprint ("Finished GMRT_TFcrop.py", logfileout='logs/checkflag.log')
